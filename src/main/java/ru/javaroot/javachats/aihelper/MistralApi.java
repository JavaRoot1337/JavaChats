...
public final class MistralApi implements AutoCloseable {
    ...
    private MistralApi(JavaChat plugin, String key, String endpoint, String model, long timeoutSeconds,
            long cooldownSeconds) {
        this.plugin = plugin;
        client = new AiProviderClient(plugin, key, endpoint, model, timeoutSeconds, cooldownSeconds, "mistral");
    }
